...
class UNet2dAttentionDsvMultiscale(nn.Module):
    ...
    def __init__(self, feature_scale=4, n_classes=1, is_deconv=True, in_channels=2,
        ...
        super(UNet2dAttentionDsvMultiscale, self).__init__()
        ...
        self.conv2 = DoubleConvBlock(filters[0] * 3, filters[1], self.is_batchnorm, kernel_size=(3, 3), padding=(1, 1))
        self.maxpool2 = nn.MaxPool2d(kernel_size=(2, 2))

        self.conv3 = DoubleConvBlock(filters[1] * 3, filters[2], self.is_batchnorm, kernel_size=(3, 3), padding=(1, 1))
        self.maxpool3 = nn.MaxPool2d(kernel_size=(2, 2))

        self.conv4 = DoubleConvBlock(filters[2] * 3, filters[3], self.is_batchnorm, kernel_size=(3, 3), padding=(1, 1))
